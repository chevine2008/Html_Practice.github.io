...
document.addEventListener('DOMContentLoaded', () => {
    ...
    audio.addEventListener('error', () => {
        console.log('Audio file not found. Add "hypermono.mp3" to enable music.');
        document.getElementById('playIcon').className = 'fas fa-volume-mute';
        document.querySelector('.audio-note p').innerHTML = '<i class="fas fa-exclamation-triangle"></i> Audio file not found. Please add "hypermono.mp3" to the same folder as this portfolio.';
    });
...
function toggleAudio() {
    ...
    if (isPlaying) {
        ...
        audio.play().then(() => {
            ...
            isPlaying = true;
            showNotification('🎵 Playing Hypermono');
        }).catch(error => {
